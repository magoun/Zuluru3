# adapted from MariaDB dockerfile for bionic
# https://github.com/docker-library/mariadb/blob/23417d54f56958b193e65ab548c34b3b336a1758/10.4/Dockerfile
...
ENV MARIADB_VERSION 1:10.4.4+maria~cosmic
# release-status:RC
# (https://downloads.mariadb.org/mariadb/+releases/)

RUN set -e;\
	echo "deb http://ftp.osuosl.org/pub/mariadb/repo/$MARIADB_MAJOR/ubuntu cosmic main" > /etc/apt/sources.list.d/mariadb.list; \
	{ \
		echo 'Package: *'; \
